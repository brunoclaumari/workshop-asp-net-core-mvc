...
using Sec17_SalesWebMvc.Models.Enums;

namespace Sec17_SalesWebMvc.Data
{
    public class SeedingService
    {
        private Sec17_SalesWebMvcContext _context;

        public SeedingService(Sec17_SalesWebMvcContext context)
        {
            _context = context;
        }
